...
export default function ServiceLayout({ service, showDetails = true, showCta = true, features = [], after, heroImage }) {
  return (
          ...
          <div className={heroImage ? 'grid items-center gap-10 lg:grid-cols-2' : ''}>
            ...
            {heroImage && (
              <div className="hidden lg:flex justify-center">
                <img src={heroImage} alt={service.title} className="w-full max-w-lg object-contain" />
              </div>
            )}
          </div>
        </div>
