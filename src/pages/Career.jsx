    ...
    <main className="flex-1 px-6 py-16">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <p className="text-blue-600 font-medium text-sm tracking-wide uppercase mb-2">Career</p>
        ...
        <div className="mt-16">
          <p className="text-center text-blue-600 font-medium uppercase tracking-wide mb-2">Open Roles</p>
          <hr className="w-16 border-blue-600 mx-auto mb-4" />
